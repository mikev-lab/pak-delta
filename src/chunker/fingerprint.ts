// 64-round constants for standard SHA-256
...
/**
 * Pure TypeScript synchronous SHA-256 implementation with zero external dependencies.
 */
export function computeChunkHashSync(bytes: Uint8Array): string {
